...
public class TabSwitcherAdapter extends RecyclerView.Adapter<TabSwitcherAdapter.ViewHolder> {
    ...
    public void setFilteredList(List<String> newList) {
        DiffUtil.DiffResult diffResult = DiffUtil.calculateDiff(new DiffUtil.Callback() {
            ...
            public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                return Objects.equals(filteredList.get(oldItemPosition), newList.get(newItemPosition));
            }

            @Override
            public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                // For contents, we consider URL, selection status, and potentially previews
                String oldUrl = filteredList.get(oldItemPosition);
                String newUrl = newList.get(newItemPosition);
                return Objects.equals(oldUrl, newUrl);
            }
        });
